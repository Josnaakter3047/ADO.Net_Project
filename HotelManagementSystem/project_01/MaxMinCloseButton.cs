...
namespace project_01
{
    static class Control
    {
        ...
        public static void DoMaximize(Form form, Button btnMax)
        {
            if (isMax == false)//app not maximized; than Maximized It!
            {
            ...
            else //app is currently maximized; then make it normal!
            {
        ...
        {
            if (isFull == false)//app not fullscreen; than fullscreen It!
            {
                old_loc = new Point(form.Location.X, form.Location.Y);
                old_size = new Size(form.Size.Width, form.Size.Height);
                Fullscreen(form);
